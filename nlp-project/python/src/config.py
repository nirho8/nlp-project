...
TRAIN_MAX_TWEETS = 10_000
TRAIN_LSTM_DROPOUT = 0.5
TEXT_HIDDEN_SIZE = 200
TEXT_OUT_SIZE = 100
TEXT_EMBEDDING_PATH = "glove.twitter.27B.50d.txt"  # TODO: Use glove.twitter.27B.50d.txt from https://nlp.stanford.edu/projects/glove/
